...
<header class="jumbotron subhead" id="overview">
	<div class="container">
		<h1>About</h1>
		<p class="lead">Learn more about our fraternity and our inception.</p>
	</div>
</header>
...
<div class="container">
	...
	<div class="row">
		<div class="span3 bs-docs-sidebar">
			<ul class="nav nav-list bs-docs-sidenav" data-spy="affix" data-offset-top="210">
		...
		<div class="span9">
			...
			<section id="goals">
				...
				<ol>
					...
					<li>Role Models to School & Community</li>
					<li>Brotherhood</li>
				</ol>
			</section>
			...
			<section id="history">
				...
				<ul> 
					...
					<li>Jose DeLeon</li> 
					<li>Jorge Dutel</li> 
					<li>Raphael Equavil</li> 
					<li>Frankie Gonzalez</li> 
					<li>Luis Gonzalez</li> 
					<li>Nelson Gonzalez</li> 
					<li>Cesar LeDuc</li> 
					<li>Eduterio Maldonado</li> 
					<li>Julio Maldonado</li> 
					<li>Angel Melendez</li> 
					<li>Nelson Molina</li> 
					<li>Waldo Morin</li> 
					<li>Roberto Muniz</li> 
					<li>Miguel Rivera</li> 
					<li>Alberto Rivera</li> 
					<li>Osvaldo Rodriguez</li> 
					<li>Jose Sabater</li> 
					<li>Raul Torres</li> 
				</ul>
			</section>
